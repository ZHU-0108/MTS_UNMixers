...
parser.add_argument('--model', type=str, default='MTS_UNMixers',
                    help='model name, options: [DLinear, Autoformer, Informer, Transformer]')
...
# K size
parser.add_argument('--k_time', type=int, default=16, help='k_time length')
parser.add_argument('--k', type=int, default=8, help='k_time length')
parser.add_argument('--alpha', type=int, default=0.0001, help='alphe weight')
parser.add_argument('--b1', type=int, default=1, help='alphe weight')
# DLinear
...
parser.add_argument('--d_model1', type=int, default=64, help='dimension of model')
parser.add_argument('--n_layers', type=int, default=1, help='num of mamba layers')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_dm1{}_bs{}_pal{}_stride{}_k{}_kt{}_A{}_dt{}_lr{}b1_{}_{}_{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
